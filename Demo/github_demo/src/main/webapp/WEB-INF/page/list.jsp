...
<span>[当前页数:   ${requestScope.page.pageCode}]</span>
<span>[总页数:     ${requestScope.page.totalPage}]</span>
        ...
        <div class="row">
            <div class="form-inline">
                <label style="font-size:14px;margin-top:22px;">
                    ...
                    &nbsp;
                    &nbsp;
                    <strong>到第</strong>&nbsp;<input type="text" size="3" id="page" name="pageCode" class="form-control input-sm"
                ...
                <ul class="pagination" style="float:right;">
                    ...
                    <li>
                        <c:if test="${requestScope.page.pageCode < requestScope.page.totalPage}">
                            <a href="<%=basePath%>/customer/findByPage.do?pageCode=${requestScope.page.pageCode + 1}">&raquo;</a>    <%--  下一页  --%>
                        </c:if>
                    </li>
                    <li>
