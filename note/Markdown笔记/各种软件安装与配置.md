...
<details>
<summary><b> Android studio 安装 </b></summary>
...
--------------------------------------------------------------------------
使用进行安装 npm install -g appium-doctor，要验证是否满足Appium的所有依赖关系， 可以使用 : appium-doctor
...
#1: 在系统变量
	...
	然后在系统变量的 path 中配置 JAVA_HOME 变量:     %JAVA_HOME%\bin
...
水星无线网卡产品
Snipaste
Windows 10 自带输入法(词语联想, 自动补全, 相当强大)
