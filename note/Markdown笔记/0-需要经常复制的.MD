...
<details>
<summary><b>spring / springMVC / SSM 常用的 pom.xml</b></summary>
...
* bootstrap  字节跳动静态资源公共库  https://cdn.bytedance.com/?query=layer&version=2.3
...
<button onclick="(function() {
     ...
     // 改变 layer 弹窗的位置(自定义)
     document.getElementsByClassName("layui-layer-msg")[0].style.cssText = " top:5px;  left:15px; ";
  })()">test</button>
